...
export const buyExperience: ExperienceConfig = {
  ...
  path: "/buy",
  title: "Home buying",
  intro: "Tell us what you're working toward. We'll map the path before any loan conversation.",
...
export const refinanceExperience: ExperienceConfig = {
  ...
  path: "/refinance",
  title: "Refinancing",
  intro: "Refinancing should serve a goal — not a rate quote.",
  question: "What are you trying to accomplish?",
...
export const homeEquityExperience: ExperienceConfig = {
  ...
  path: "/heloc",
  title: "Home equity",
  intro: "Your equity can create options. The goal comes first.",
